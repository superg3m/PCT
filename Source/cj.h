...
//
    ...
    static CJ_ArenaPage* cj_arena_page_create(size_t allocation_size) {
        ...
        ret->base_address = (u8*)cj_alloc(allocation_size);
    ...
    CJ_Arena* MACRO_cj_arena_create(size_t allocation_size, CJ_ArenaFlag flag, u8 alignment) {
        ...
        CJ_ArenaPage* inital_page = cj_arena_page_create(allocation_size ? allocation_size : ARENA_DEFAULT_ALLOCATION_SIZE);
